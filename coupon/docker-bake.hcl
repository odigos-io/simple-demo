# Coupon: build and package targets (use from coupon dir: docker buildx bake -f docker-bake.hcl [target])
...
variable "IMAGE" {
  default = "coupon-package"
}

variable "APP_IMAGE" {
  default = "registry.odigos.io/odigos-demo-coupon"
}
